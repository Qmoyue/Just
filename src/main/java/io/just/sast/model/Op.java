...
/**
 * JVM 操作码（model 层不依赖 ASM，使用 JVM 规范标准编号）。
 * ASM 树 API 会将 WIDE/LDC_W/LDC2_W/GOTO_W/JSR_W 规范化，因此此处不含这些编码。
 */
public enum Op {
    NOP(0), ACONST_NULL(1),
    ICONST_M1(2), ICONST_0(3), ICONST_1(4), ICONST_2(5), ICONST_3(6), ICONST_4(7), ICONST_5(8),
    LCONST_0(9), LCONST_1(10), FCONST_0(11), FCONST_1(12), FCONST_2(13), DCONST_0(14), DCONST_1(15),
    BIPUSH(16), SIPUSH(17), LDC(18),
    ...
    MONITORENTER(194), MONITOREXIT(195), MULTIANEWARRAY(197),
    ...
    private static final Op[] BY_CODE = new Op[256];
    ...
    public boolean isReturn() {
        return this == IRETURN || this == LRETURN || this == FRETURN || this == DRETURN
                || this == ARETURN || this == RETURN || this == ATHROW;
    }

    public boolean isCondJump() {
        return (code >= IFEQ.code && code <= IF_ACMPNE.code) || this == IFNULL || this == IFNONNULL;
    }

    public boolean isUncondJump() {
        return this == GOTO || this == JSR;
    }

    public boolean isSwitch() {
        return this == TABLESWITCH || this == LOOKUPSWITCH;
    }

    public boolean isInvoke() {
        return this == INVOKEVIRTUAL || this == INVOKESPECIAL || this == INVOKESTATIC
                || this == INVOKEINTERFACE || this == INVOKEDYNAMIC;
    }
    ...
    public boolean isLoad() {
        return this == ILOAD || this == LLOAD || this == FLOAD || this == DLOAD || this == ALOAD;
    }
